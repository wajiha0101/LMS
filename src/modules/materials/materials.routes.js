...
materialsRouter.post("/courses/:id/materials",authMiddleware,requireRole("INSTRUCTOR"),validate(createMaterialSchema),
  createMaterialController
);
materialsRouter.get("/courses/:id/materials",authMiddleware,requireRole("INSTRUCTOR", "STUDENT"),
  listMaterialsController
);
materialsRouter.patch("/materials/:id",authMiddleware,requireRole("INSTRUCTOR"),validate(updateMaterialSchema),
